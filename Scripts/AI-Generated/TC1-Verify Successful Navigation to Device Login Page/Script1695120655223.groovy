...
'step 3: Add visual checkpoint at Page_dvc-login'

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Successful Navigation to Device Login Page_visual_checkpoint')
