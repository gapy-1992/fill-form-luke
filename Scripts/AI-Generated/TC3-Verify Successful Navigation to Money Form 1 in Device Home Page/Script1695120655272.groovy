...
'step 3: Add visual checkpoint at Page_dvc-home_money-form1'

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Successful Navigation to Money Form 1 in Device Home Page_visual_checkpoint')
